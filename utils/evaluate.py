...
def get_performance(user_pos_test, recomm_items, r, auc, Ks):
    precision, recall, ndcg, hit_ratio, ild  = [], [], [], [], []
...
def test_one_user(x):
    ...
    if args.test_flag == 'part':
        l, r, auc = ranklist_by_heapq(user_pos_test, test_items, rating, Ks)
    else:
        l, r, auc = ranklist_by_sorted(user_pos_test, test_items, rating, Ks)

    return get_performance(user_pos_test, l, r, auc, Ks)
